...
-------- Menu draw --------
local hotkey = ui.new_checkbox('LUA', 'B', 'Minimum damage override')
local hotkey = ui.new_hotkey('LUA', 'B', 'Minimum damage override', true)
...
local y = sh - 200
	...
	if reduce then
		c_draw(c, 58, y + 85, 124, 195, 13, 255, "c+", 0, "DAMAGE")
	end		
end
